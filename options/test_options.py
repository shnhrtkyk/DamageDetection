...
class TestOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--model', default="dmg", help='model to train,options:fcn8,segnet...')
        self.parser.add_argument('--model-dir', default="./save_models_dmg/dmg_15.pth", help='path to stored-model')
        ...
        self.parser.add_argument('--savedir', type=str, default='./results_dmg/',help='options. visualize the result of segmented picture, not just show IoU')
