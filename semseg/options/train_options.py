...
class TrainOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--model', default="dmg_mod", help='model to train,options:fcn8,segnet...')
        ...
        self.parser.add_argument('--savedir', type=str, default='./save_models_dmg_mod_bin/',help='savedir for models')
        ...
        self.parser.add_argument('--pretrained',type=str, default='./save_models/att_35.pth')
